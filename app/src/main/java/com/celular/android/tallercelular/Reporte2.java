...
public class Reporte2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < celular.size() ; i++) {
            ...
            if(celular.get(i).getMarca().equals("Samsung")&& ((celular.get(i).getCapacidadRam().equals("2GB"))||celular.get(i).getCapacidadRam().equals("3GB")||celular.get(i).getCapacidadRam().equals("4GB"))){
